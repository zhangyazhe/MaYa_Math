(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/错题本/errorbk.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '35e42o+7PtJC72bVa2mWBUS', 'errorbk', __filename);
...
cc.Class({
    ...
    bt_commit_Clicked: function bt_commit_Clicked() {
        ...
        if (this.input.length == 0) {
            ...
            this.input = "";
            this.lable_input.string = this.input;
            if (this.seq != this.errorbook.length + 1) this.defaultGame();else {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=errorbk.js.map
